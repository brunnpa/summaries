% SAMPLE:
% [a_post, iter, alpha] = III_Nullstellen_BanachInklAblParam_brunnpa7(@(x) x.^23+0.3, @(x) 3.*x.^2, 0, 3, 0.5)
function [a_post, iter, alpha] = III_Nullstellen_BanachInklAblParam_brunnpa7(func, func_abl, startInt, endInt, fehler)
    % initialize
    a_post = 0;
    iter = 0;
    alpha = 0;
