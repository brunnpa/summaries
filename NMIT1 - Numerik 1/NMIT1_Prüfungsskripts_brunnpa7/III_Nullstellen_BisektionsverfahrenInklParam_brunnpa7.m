...
% 
% Beispielaufruf:
% [root, xit, n] = III_Nullstellen_BisektionsverfahrenInklParam_brunnpa7(@(x) sin(x).*cos(x), -1, 1, 0.1)

function [root, xint, n] = III_Nullstellen_BisektionsverfahrenInklParam_brunnpa7(func, a, b, tol)
    % Format definieren
    format long;
