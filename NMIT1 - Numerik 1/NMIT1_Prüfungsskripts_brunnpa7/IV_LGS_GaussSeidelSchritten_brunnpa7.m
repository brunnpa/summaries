...
%
% BEISPIELAUFRUF
% [xGau, iterations, estimatedIteration] = IV_LGS_GaussSeidelSchritten_brunnpa7([4 -1 1; -2 5 1; 1 -2 5], [5; 11; 12], [0;0;0], 10)
function [xGau, iterations, estimatedIteration] = IV_LGS_GaussSeidelSchritten_brunnpa7(A, b, x, nMax)
    format long;
    
    % Toleranz für a-posteriori angeben
    tolerance = 10.^-4;
