% Berechnet Anfangswertproblem für sämtliche Euler Verfahren
% PARAMETER
% f = the function
% a = startwert
% b = endwert
...
%
% SAMPLE
% [x, y_euler, y_mittelpunkt, y_modeuler] = HELPER_EULER(@(x,y) x.^2 ./ y ,0,2.1,3,2)
function [x, y_euler, y_mittelpunkt, y_modeuler] = HELPER_EULER(f,a,b,n,y0)
