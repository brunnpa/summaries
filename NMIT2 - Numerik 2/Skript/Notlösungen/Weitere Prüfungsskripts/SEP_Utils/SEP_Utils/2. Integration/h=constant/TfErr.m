function    [max_err]   =   TfErr(a, b, h, f, step)
% Test:     [max_err]   =   TfErr(0, 0.5, [1/4, 1/8, 1/16, 1/32, 1/64], @(x)exp(1).^(-x.^2), 0.001)
%           
%           Berechnet den maximalen Fehler der summierten Trapez-Regel
% Params:   
